...
#Problem
Looking for books on the internet can be intimidating, especially with all the distractions
and hundreds of online book stores to buy from. This app solves this problem by simplifying and
streamlining the process so you can get to your next book in no time.
...
Unless you're very familiar with iOS credentials already, it's best to let Expo handle the creation & management of all your credentials for you. If you'd like to know more about iOS credentials, we've written a guide with everything you need to know here.
